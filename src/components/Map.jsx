...
const Map = () => {
  return (
    <section className="relative mx-auto max-w-9/10 h-64 sm:h-84 bg-gray-300">
      <img src={map} className="object-cover sm:w-full h-full"/>
      <div className="absolute flex-col top-10 left-5 bg-white pl-2 sm:pl-5 pb-5 rounded-base w-6/10 md:w-4/10 lg:w-8/20 h-3/4 ">
